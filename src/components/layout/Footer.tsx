...
const Footer = () => {
  return (
    <footer className="footer">
        ...
        <div id="footer-social-media" className="footer-content">
          ...
          <div aria-label="social-media">
            <a href="#" className="icons">
              <i className="fa-brands fa-square-instagram icon-style"></i>
            </a>
            <a href="#" className="icons">
              <i className="fa-brands fa-square-x-twitter icon-style"></i>
            </a>
          </div>
        </div>
      </div>
      ...
      <hr />
      <p id="copyright">&copy; 2024 | Designed by Suzan Arrubaee</p>
    </footer>
  )
}
